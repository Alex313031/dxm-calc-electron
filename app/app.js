...
function createWindow () {
  ...
  },
  {
    ...
    label: 'About',
    submenu: [
      { label: 'DXM Calculator v' + app.getVersion(), enabled: false },
      { label: 'Created by Alex313031',
        click() {
          new BrowserWindow({width: 1024, height: 768, useContentSize: true}).loadURL('https://github.com/Alex313031/dxm-calc-electron#readme');
        }
      },
      { type: 'separator' },
      {
...
electronLog.info('Welcome to DXM Calculator!');
